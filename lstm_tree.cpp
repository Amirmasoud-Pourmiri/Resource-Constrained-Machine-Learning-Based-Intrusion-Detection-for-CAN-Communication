...
// Updated DOT parser to handle named features like "t9:Timestamp <= 0.5".
//
// Build: g++ -O2 -std=c++17 ids_labeled_pycompat.cpp -o ids
// Run:   ./ids
//
// Needs: L_pruned_tree.dot  (your exported/pruned tree in DOT format)
...
/* ───────── DOT parser (updated for named features like t9:Timestamp) ───────── */
